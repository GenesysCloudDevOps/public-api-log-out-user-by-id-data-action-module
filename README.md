A Terraform/CX as Code remote module for the following Genesys Cloud public API operation: Log Out User by ID
...
```hcl
module "data_action" {
    source             = "git::https://github.com/GenesysCloudDevOps/public-api-log-out-user-by-id-data-action-module.git?ref=v1.0.0"
    action_name        = "Log Out User by ID"
